...
ниже. Всего в схеме 48 таблиц и 68 индексов.
...
| Политика | на каждой таблице с `tenant_id`: строка видна, если `tenant_id` равен настройке сеанса или пользователь состоит в платформенной роли; `organizations` дополнительно видна участнику, `memberships` — самому пользователю |
...
```mermaid
flowchart LR
  B["бинарник со встроенными<br/>000001…000021.sql"] --> L["advisory-lock<br/>одна транзакция"]
