...
Этапы 2–6 теперь образуют связный PostgreSQL-контур от регистрации организации
до аварийно восстанавливаемой канонизации переписки. Проверки ограничений базы,
повторных событий, ролей, изоляции организаций, аренды и исходящего журнала
проходят на PostgreSQL 18. Не закрыты все живые сценарии Telegram, перенос
двоичных вложений в объектное хранилище и RLS, который по ТЗ относится к этапу
24.

Общая очередь этапа 6 готова принимать задания следующих доменов, но сама по
себе не превращает реализации этапов 7–15, работающие только в памяти, в
производственные PostgreSQL-модули. Этап 15 даёт воспроизводимый контур
измерений, но его выходной критерий не пройден без размеченного набора,
выбранной модели и измерения на целевом оборудовании.
