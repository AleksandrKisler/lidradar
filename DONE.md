...
| 8 | Прототип, не подключено | Правило `NO_RESPONSE` и расчёт рабочего времени есть; PostgreSQL-хранилища, планирование и worker отсутствуют. |
| 9–12 | Прототип, не подключено | Radar, уведомления, действия, результаты и выручка проверены преимущественно в памяти. |
...
себе не превращает прототипы этапов 8–15 в производственные PostgreSQL-модули.
